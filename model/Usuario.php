 ...
 * 
 * esta funcion llama a l afuncion validarUsuario de la clase UsuarioPDO
 * 
 * @param type $codUsuario el codigo de usuario que le pasamos por el formulario
 * @param type $password la contraseña que le pasamos por el formulario
